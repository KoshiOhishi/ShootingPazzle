...
namespace DX12Library {
	...
	public:
		...
		void ParseOBJ(const std::string& line, const std::string& directoryPath, bool smoothing, vector<Vector3>& positions, vector<Vector3>& normals, vector<Vector2>& texcoords);
