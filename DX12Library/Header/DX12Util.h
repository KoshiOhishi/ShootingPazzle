...
namespace DX12Library {
	...
	public:
		static void Initialize(const wchar_t* windowName = L"DirectXGame", int windowWidth = 1280, int windowHeight = 720, double setfps = 0);
		static void Update();
		...
		/// <summary>
		/// カメラのセットが必要なオブジェクトにまとめてセットする
		/// </summary>
		/// <param name="camera"></param>
		static void SetCameraAll(Camera* camera);
